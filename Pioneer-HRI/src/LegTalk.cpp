...
//                                     sc.playWave("/home/shokoofeh/ros/ros_workspace/RobotSounds/A/AHey.wav");
//                                     sleep(1);
...
//				ROS_INFO("k+1 : [%f]", ranges.at(k+1)); 
				 	if ( ((ranges.at(i+1) < 0.8) || (ranges.at(j) < 0.8) || (ranges.at(m) < 0.8)) || (fabs(error) > 20.0)){
					
//						ROS_INFO("nearest point is : [%f]", ranges.at(c));
						cmd_vel.linear.x = 0.0;
                                                cmd_vel.angular.z = 0.0;
                                                sc.playWave("/home/shokoofeh/ros/ros_workspace/RobotSounds/A/AFinished1.wav");
                                                sleep(0.5);
						break;
                                   }
